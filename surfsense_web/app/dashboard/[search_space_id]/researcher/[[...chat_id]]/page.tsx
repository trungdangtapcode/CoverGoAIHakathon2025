			...
			if (initialState) {
				try {
					...
					if (parsed.youtubeUrls) {
						setYoutubeUrls(parsed.youtubeUrls);
					}
					localStorage.removeItem(initialStateKey); // Clean up
				} catch (error) {
					console.error("Error parsing initial chat state:", error);
				}
			} else {
