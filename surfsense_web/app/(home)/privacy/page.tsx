...
export const metadata: Metadata = {
	title: "Privacy Policy | Strawberries",
	description: "Privacy Policy for Strawberries application",
};
		...
		<div className="container max-w-4xl mx-auto py-12 px-4">
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p>
						Welcome to Strawberries. We respect your privacy and are committed to protecting your
