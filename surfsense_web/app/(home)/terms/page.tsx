...
export const metadata: Metadata = {
	title: "Terms of Service | Strawberries",
	description: "Terms of Service for Strawberries application",
};
		...
		<div className="container max-w-4xl mx-auto py-12 px-4">
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p>
						Welcome to Strawberries. These Terms of Service govern your access to and use of the
						Strawberries website and services. By accessing or using our services, you agree to be
